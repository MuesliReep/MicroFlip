...
bool Config::loadConfigFromFile(const QString& fileName) {
    ...
    static const QString DEFAULT_REMOTE_SERVER_KEY   = "";
    static const QString DEFAULT_REMOTE_PRIVATE_KEY  = "";
    ...
    if(!file.exists()) {
        ...
        settings.setValue("Remote/ServerKey",       DEFAULT_REMOTE_SERVER_KEY  );
        settings.setValue("Remote/PrivateKey",      DEFAULT_REMOTE_PRIVATE_KEY );
    ...
    this->remoteServerKey  = settings.value("Remote/ServerKey",       DEFAULT_REMOTE_SERVER_KEY  ).toString ();
    this->remotePrivateKey = settings.value("Remote/PrivateKey",      DEFAULT_REMOTE_PRIVATE_KEY ).toString ();
...
void Config::saveConfigToFile(const QString& fileName) {
    ...
    settings.setValue("Remote/ApiKey",          this->remoteServerKey       );
    settings.setValue("Remote/ApiSecret",       this->remotePrivateKey      );
...
QString Config::getRemoteServerKey  () const { return remoteServerKey;  }
QString Config::getRemotePrivateKey () const { return remotePrivateKey; }
